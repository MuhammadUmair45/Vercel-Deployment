      ...
      {blogPostsContent.map((item) => (
        ...
        >
          <div className="group relative overflow-hidden">
            <div className="relative h-[395px] before:absolute before:left-0 before:top-0 before:hidden before:size-full before:bg-black before:opacity-0 before:content-[''] group-hover:before:block group-hover:before:opacity-35">
              <Image
          ...
          <div>
            <div className="mb-8 mt-10 flex flex-wrap xl:flex-nowrap">
              <Link
              ...
              <ul className="flex basis-full flex-wrap items-center pt-7 *:mt-2 *:basis-[44%] md:basis-auto lg:flex-nowrap lg:*:mt-0 lg:*:basis-auto xl:pt-0">
            ...
            <h3>
              <Link
                className="mb-3 inline-block text-[32px] font-bold text-[#101010] hover:text-primary leading-none"
                href={item.linkHref}
              >
                {item.title}
              </Link>
